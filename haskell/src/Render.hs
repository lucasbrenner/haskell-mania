...
render game @ Game { gameState = Menu } =
    pictures [ mkText white "haskell!mania" 0.5 0.5 (-190) 200
             , mkText white "Controls: D, F, J, K" 0.3 0.3 (-195) 100
             , mkText white "Select Map: ENTER" 0.3 0.3 (-185) (0)
             , mkText white "Quit: ESC" 0.3 0.3 (-90) (-100)
